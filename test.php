...
// Функция должна вывести список нечётных чисел в заданном диапазоне. Например: В функцию передали: 10 и 35.
// Функция должна вывести список нечётных чисел в диапазоне от 10 до 35.

function homeTask6($arg1, $arg2)
{
    if ($arg1 % 2)
    {
        echo $arg1 . " ";
